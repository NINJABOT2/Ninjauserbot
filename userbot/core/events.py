...
async def send_message(
    ...
    *,
    ...
    if safecheck:
        ...
        msg = f"**Sorry, This Is Sensitive Data I Cant Send It To Public.& Reported to Admin Of NinjaBot Group [admin](https://t.me/NinjaBot_OP). & Dont Try To Send Any Information Without Knowing Anything.** ▶️ [Logger group]({msglink})"
        return await client.sendmessage(
            entity=chatid,
            message=msg,
            reply_to=reply_to,
