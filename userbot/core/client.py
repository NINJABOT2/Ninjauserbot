...
class NinjaClient(TelegramClient):
    def Ninja_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**NinjaBot Error report**\n\n"
                        link = "[here](https://t.me/NinjaBot_OP)"
            ...
            if pattern is not None:
                ...
                if edited:
                    Ninja.add_event_handler(func, events.MessageEdited(**kwargs))
                Ninja.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                Ninja.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                Ninja.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
NinjaClient.fast_download_file = download_file
NinjaClient.fast_upload_file = upload_file
NinjaClient.reload = restart_script
NinjaClient.get_msg_link = get_message_link
NinjaClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    NinjaClient.send_message = send_message
    NinjaClient.send_file = send_file
    NinjaClient.edit_message = edit_message
