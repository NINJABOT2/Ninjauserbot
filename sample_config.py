...
class Config(object):
    ...
    Ninja_STRING = os.environ.get("Ninja_STRING", None)
    ...
    # set this with required Ninja repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/NINJABOT2/NINJABOT2.0.git"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Ninjauserbot")
    ...
    # Google Drive plugin https://telegra.ph/G-Drive-guide-for-Ninjauserbot-01-01
